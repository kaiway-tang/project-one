...
public class AnimatorController : MonoBehaviour
{
    ...
    [SerializeField] int firstEmptyQueSlot, activeAnimations;
    ...
    [SerializeField] bool currentStateHasReference;
    ...
    {
        currentStateHasReference = currentState.hasReference;
    ...
    {
        if (currentState.getID() != referenceState.getID() || !currentState.hasReference)
        {
